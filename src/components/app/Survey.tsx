...
import { surveyApi, tryApi, isAuthenticated } from "@/lib/api";
  ...
  async function finish() {
    ...
    if (isAuthenticated()) {
      try {
        ...
        // don't block onboarding, but inform the user
        toast.error("Impossible d'envoyer le questionnaire au serveur");
      }
    }
