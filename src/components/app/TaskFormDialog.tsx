...
/** Mirror de TaskCreateRequest.java */
...
/** Mirror de TaskUpdateRequest.java — tous les champs optionnels */
export type TaskUpdateRequest = Partial<Omit<TaskCreateRequest, "studentId">>;

/** Mirror de TaskResponse.java */
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    if (mode === "create") {
      const payload: TaskCreateRequest = {
        studentId: localStorage.getItem("sc-student-id") || "local-student",
        ...parsed.data,
      };
      onSubmit(payload);
